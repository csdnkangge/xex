...
<template>
  <el-card>
    ...
    >
      ...
      <el-table-column prop="coinSymbol" label="币种" align="center" />
      <el-table-column prop="depAmount" label="充值金额" align="center" />
      <el-table-column
        prop="depAccumulative"
        label="累计充值金额"
        align="center"
      />
      <el-table-column prop="positionAmount" label="持仓量" align="center" />
      <el-table-column prop="buyAmount" label="买入量" align="center" />
      <el-table-column
        prop="buyAccumulative"
        label="累计买入量"
        align="center"
      />
      <el-table-column prop="sellAmount" label="卖出量" align="center" />
      <el-table-column
        prop="sellAccumulative"
        label="累计卖出量"
        align="center"
      />
      <el-table-column prop="presentAmount" label="赠币量" align="center" />
...
export default {
  ...
  methods: {
    ...
    getTableData() {
      ...
      //   }
      // });
      if(!this.baseInfo.selectedDateStart){
        this.$set(this.baseInfo,'selectedDateStart','2020-01-01')
      }
      Api.getDataList(this.baseInfo).then(res => {
