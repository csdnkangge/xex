<!--  -->
<template>
  <el-card class="partner_list_container">
    <div class="page_title">
      <span class="line"></span>{{ $t("partner_list.title") }}
    </div>
    ...
    >
      <el-table-column
        :label="$t('partner_list.partner_account')"
        align="center"
        width="160"
      >
      ...
      <el-table-column
        prop="rate"
        :label="$t('partner_list.commission_ratio') + '(%)'"
        align="center"
        width="180"
      />
      <el-table-column
        :label="$t('partner_list.contact_info')"
        align="center"
        width="160"
      >
        <template slot-scope="scope">
      ...
      <el-table-column
        :label="$t('partner_list.partners_num')"
        prop="directNextAgent"
        align="center"
        width="100"
      />
      <el-table-column
        :label="$t('partner_list.nodes_total_people')"
        prop="allNextAgent"
        align="center"
        width="160"
      />
      <el-table-column
        :label="$t('partner_list.nodes_deposit_num')"
        prop="depositUserCount"
        align="center"
        width="180"
      />
      <el-table-column
        :label="$t('partner_list.nodes_net_recharge')"
        width="160"
        prop="deposit"
        align="center"
      />
      <el-table-column
        :label="$t('partner_list.nodes_withdraw_num')"
        prop="withdraw"
        width="160"
        align="center"
      />
      <el-table-column
        :label="$t('partner_list.nodes_total_assets')"
        prop="totalAmount"
        width="150"
        align="center"
      />
      <el-table-column
        :label="$t('partner_list.nodes_total_fee')"
        prop="allNextAgentFuturesFee"
        width="150"
        align="center"
      />
      <el-table-column
        :label="$t('partner_list.be_partner_time')"
        prop="regesterTime"
        align="center"
        width="170"
