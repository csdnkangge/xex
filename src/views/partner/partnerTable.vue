<!--  -->
<template>
  <el-card class="partner_table_container">
    <div class="page_title">
      <span class="line"></span>{{ $t("partner_table.title") }}
    </div>
    ...
    >
      <el-table-column
        :label="$t('partner_table.partner_account')"
        align="center"
        width="160"
      >
      ...
      <el-table-column
        prop="rate"
        :label="$t('partner_table.commission_ratio') + '(%)'"
        align="center"
        width="180"
      />
      <el-table-column
        :label="$t('partner_table.user_contract_fee')"
        prop="myTotalFuturesFee"
        align="center"
        width="150"
      />
      <el-table-column
        :label="$t('partner_table.new_registrants')"
        prop="newRegisterCount"
        align="center"
        width="150"
      />
      <el-table-column
        :label="$t('partner_table.new_withdraw_count')"
        prop="newWithdrawCount"
        align="center"
        width="120"
      />
      <el-table-column
        :label="$t('partner_table.nodes_deposit_num')"
        prop="depositUserCount"
        align="center"
        width="120"
      />
      <el-table-column
        :label="$t('partner_table.nodes_withdraw_num')"
        prop="withdrawUserCount"
        align="center"
        width="140"
      />
      <el-table-column
        :label="$t('partner_table.nodes_people_number')"
        width="130"
        prop="allNextAgent"
        align="center"
      />
      <el-table-column
        :label="$t('partner_table.nodes_net_recharge')"
        width="160"
        prop="deposit"
        align="center"
      />
      <el-table-column
        :label="$t('partner_table.nodes_withdraw_amount')"
        width="140"
        prop="withdraw"
        align="center"
      />
      ...
      <el-table-column
        :label="$t('partner_table.be_partner_time')"
        prop="regesterTime"
        align="center"
        width="170"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        rate: [{ required: true, message: "请填写返佣比例", trigger: "blur" }]
      },
      formData: {
        userCode: "",
        userName: "",
