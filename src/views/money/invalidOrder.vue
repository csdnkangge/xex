<!--  -->
<template>
  <el-card class="invalid_order_container">
    <div class="page_title">
      <span class="line"></span>{{ $t("invalidOrder.title") }}
    </div>
    <div class="total_info">
      <div class="total_amount info-item">
        {{ $t("invalidOrder.feeTotal") }}：<span class="DP-Bold">{{
          sumUsdt
        }}</span>
    ...
    <el-form :inline="true" label-position="top">
      ...
      <el-form-item
        :label="$t('invalidOrder.contract_name')"
      ...
      >
        <el-select
          ...
          filterable
          clearable
          :placeholder="$t('invalidOrder.all')"
        >
          <el-option
      ...
      <el-form-item
        :label="$t('invalidOrder.transaction_date')"
